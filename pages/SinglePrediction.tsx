...
const SinglePrediction: React.FC = () => {
  ...
  const handleSelectCustomer = async (customer: Customer) => {
    ...
    setAnalyzing(true);
    // Simulate analyzing time with a bit of randomness for realism
    setTimeout(async () => {
  ...
  const getRiskColorClasses = (score: number) => {
    if (score > 70) return 'text-brand-red border-brand-red bg-red-500/10 shadow-[0_0_20px_rgba(229,9,20,0.2)]';
    if (score > 40) return 'text-yellow-500 border-yellow-500 bg-yellow-500/10 shadow-[0_0_20px_rgba(234,179,8,0.2)]';
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="glass-panel p-8 rounded-2xl border border-white/10 relative overflow-hidden group flex flex-col items-center justify-center min-h-[400px]">
                ...
                <div className="relative flex items-center justify-center">
                     {/* Glow effect behind */}
                     <div className={`absolute inset-0 blur-2xl rounded-full scale-90 transition-colors duration-1000 ${prediction.churnProbability > 70 ? 'bg-brand-red/20' : prediction.churnProbability > 40 ? 'bg-yellow-500/20' : 'bg-green-500/20'}`}></div>
                ...
                <div className="space-y-4">
                     ...
                     <div className="flex items-center gap-4 group cursor-pointer p-2 rounded-xl hover:bg-white/5 transition-colors" onClick={() => setActionTaken('Email Campaign')}>
                         ...
                         <div className="flex-1">
                             ...
                             <p className="text-gray-500 text-sm">Re-engagement offer recommended</p>
                         </div>
